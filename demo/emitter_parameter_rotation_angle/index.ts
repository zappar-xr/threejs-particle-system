...
const rainParticle = new URL('../rain-particlel.jpeg', import.meta.url).href;
...
const setupEmitterGroup = (
  ...
  emitter.rotation.axis = new THREE.Vector3(1, 1, 0);
  emitter.rotation.angle = THREE.MathUtils.degToRad(45);
  emitter.rotation.static = false;

  _emitterGroup.texture = texture;
  _emitterGroup.addEmitter(emitter);
  _emitterGroup.mesh.position.set(0, 0, 1);
