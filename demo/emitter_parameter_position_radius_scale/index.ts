...
const setupEmitterGroup = (
  ...
  const emitter = new ParticleSystem.Emitter({
    ...
    velocity: {
      ...
      spread: new THREE.Vector3(0, 1, 1),
    },
    acceleration: {
  ...
  emitter.position.radius = 0.1;
  emitter.position.radiusScale = new THREE.Vector3(1, 5, 1);
  emitter.type = ParticleSystem.IDistribution.SPHERE;

  // emitter.position.radius = 10;
  emitter.position.value = new THREE.Vector3(0, 0, -5);
